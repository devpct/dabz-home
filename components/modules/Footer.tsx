      ...
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className='text-center m-auto'>
          ...
          <div className="flex items-center mt-7 gap-x-5 gap-y-5  justify-center flex-wrap">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13.9999 24H9.24151V12.1696H6V8.31792H9.24139V5.57715C9.24139 2.32932 10.6751 0 15.4206 0C16.4243 0 18 0.201761 18 0.201761V3.7783H16.345C14.6586 3.7783 14.0002 4.28988 14.0002 5.70422V8.31792H17.9369L17.5863 12.1696H14L13.9999 24Z" fill="white"/>
            </svg>
