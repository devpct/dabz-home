...
export default function Header() {
  return (
    <>
  <div className="w-full px-[1rem] pt-[6rem] h-[63rem] bg-no-repeat bg-cover bg-[100%] text-center flex flex-col gap-y-8" style={{backgroundImage: "url('/images/header.png')"}} >
